...
class Report3Class:
    def __init__(self,hwindow):
        ...
        self.hdlbl = Label(self.window,text='Student Report By DOB',background='grey',font=('Cambria',20,'bold'))
        ...
        self.b2 = Button(self.window,text='Search',font=myfont1,background='#E3E1D9',command=self.showAllData)
        ...
        self.b2.place(x=x1+500,y=y1,height=25,width=70)
        y1+=y_diff
